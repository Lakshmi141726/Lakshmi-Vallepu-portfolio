	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'skill-gradient': 'linear-gradient(45deg, hsl(var(--skill-tag)), hsl(var(--hero-gradient-end)))'
			},
			boxShadow: {
				'portfolio-light': 'var(--shadow-light)',
				'portfolio-medium': 'var(--shadow-medium)',
				'portfolio-heavy': 'var(--shadow-heavy)'
			},
			borderRadius: {
				lg: 'var(--radius)',
